...
const Footer = () => {
  return (
    <footer className="bg-muted-purple px-5 md:px-20 py-20 static bottom-0 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-20 gap-x-[20%]">
      <div className="space-y-20">
        ...
        <div className="divide-x-4 divide-magenta grid grid-cols-2 text-center w-[80%] mt-auto">
